...
avg <- logreg %>% # WHY DEFAULTS TO FIRST DATETIME - WANT TO DEFAULT TO LAST
  group_by(id, ymd) %>%
  dplyr::summarise(mean(SIC_30m_me), mean(SIC_30m_max), mean(SIC_30m_min), mean(SICsq), mean(dist2land[,1]))

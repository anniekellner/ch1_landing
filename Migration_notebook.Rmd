...
- Todd did not use 30% ice concentration in his model set. I was interested in this number because it emerged in the top model in the Canadian analysis (Hudson Bay). The Canadian analysis predates Todd's, so I'd be curious why he did not use the 30% measurement.

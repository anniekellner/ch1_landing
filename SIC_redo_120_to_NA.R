...
sub <- subset(bears, year == 2005)


#---------------- SPATIAL DATA ---------------------#

rasterlist <- list.files('C:/Users/akell/Documents/PhD/Polar_Bears/Data/SIC-TIFs/SIC_univ_Bremen/n3125/OWS_2005', pattern='.tif', all.files=TRUE, recursive = TRUE, full.names=TRUE)

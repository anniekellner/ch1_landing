...
pb <- subset(all.v2, animal=='pb_21358' & datetime > '2013-07-15' & datetime < '2013-08-15') 
...
rasterlist <- list.files('./SIC-TIFs/MASIE/pb_21358', full.names = TRUE) # bring in all files

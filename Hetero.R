...
pb <- subset(all.v2, animal=='pb_21368' & datetime > '2014-07-12' & datetime < '2014-08-12') 
...
rasterlist <- list.files('./SIC-TIFs/MASIE/pb_21368', full.names = TRUE) # bring in all files

...
pb <- subset(all.v2, animal=='pb_20735' & datetime > '2009-06-25' & datetime < '2009-07-26') 
...
rasterlist <- list.files('./SIC-TIFs/MASIE/pb_20735', full.names = TRUE) # bring in all files

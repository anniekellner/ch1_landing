...
pb <- subset(all.v2, animal=='pb_21264' & datetime > '2011-06-28' & datetime < '2011-07-29') 
...
rasterlist <- list.files('./SIC-TIFs/MASIE/pb_21264', full.names = TRUE) # bring in all files

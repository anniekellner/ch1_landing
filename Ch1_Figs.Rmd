...
borders <- st_read("C:/Users/akell/Documents/PhD/Polar_Bears/R-Plots/ne_10m_admin_0_boundary_lines_land/ne_10m_admin_0_boundary_lines_land.shp")
...
mcp <- st_read("./Shapefiles/95ca_ows_all.shp")
mcp <- st_transform(mcp, crs = 4326)
  

ggsave("arctic_birdseye.png", plot = inset, path = "C:/Users/akell/Documents/PhD/Polar_Bears/R-Plots")

main <- basemap(limits = c(-175, -130, 65, 80), rotate = TRUE, bathymetry = TRUE, bathy.style = "poly_blues", land.col = "#9ECBA0") + 
  annotation_scale(location = "br") + 
  annotation_north_arrow(location = "bl", which_north = "true") +
  theme(axis.title.x = element_blank(),
        axis.title.y = element_blank()) + 
  geom_sf(data = arctic_circle, color = "black") + 
  coord_sf(xlim = c(-175, -130), ylim = c(65, 80)) 

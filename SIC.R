...
rasterlist <- list.files('./SIC-TIFs/SIC_univ_Bremen/pb_32366_11', full.names = TRUE)# bring in all files

load('all_v2.Rdata')
pb <- subset(all, id=='pb_32366.2011' & ymd >= '2011-07-06' & ymd <= '2011-08-06') # subsetting from master data file ('all.Rdata')

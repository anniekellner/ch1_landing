...
rasterlist <- list.files('./SIC-TIFs/SIC_univ_Bremen/pb_20529_05', full.names = TRUE)# bring in all files

load('all_v2.Rdata')
pb <- subset(all, id=='pb_20529.2005' & ymd >= '2005-08-20' & ymd <= '2005-09-20') # subsetting from master data file ('all.Rdata')

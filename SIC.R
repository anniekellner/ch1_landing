...
rasterlist <- list.files('./SIC-TIFs/SIC_univ_Bremen/pb_20520', full.names = TRUE)# bring in all files

load('all_v2.Rdata')
pb <- subset(all, id=='pb_20520.2012' & ymd >= '2012-07-15' & ymd <= '2012-08-15') # subsetting from master data file ('all.Rdata')
